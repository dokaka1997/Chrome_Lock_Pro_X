(function initClpxI18n(globalScope) {
  ...
  Object.assign(messages.vi, {
    ...
    'options.biometric.help': 'Dung Windows Hello hoac trinh xac thuc tren thiet bi de Chrome xac minh van tay, khuon mat hoac ma PIN cua may truoc khi mo khoa.',
    'options.biometric.status.ready': 'Da cau hinh',
    'options.biometric.status.not_setup': 'Chua thiet lap',
    'options.biometric.messages.password_first': 'Hay tao mat khau truoc, sau do moi dang ky mo khoa sinh trac hoc.',
    'options.biometric.messages.request_failed': 'Khong mo duoc cua so sinh trac hoc.',
    'options.biometric.messages.window_opened': 'Da mo cua so sinh trac hoc. Hay hoan tat xac minh tai do.',
    'options.biometric.messages.registered': 'Mo khoa sinh trac hoc da san sang.',
    'options.biometric.messages.removed': 'Da xoa mo khoa sinh trac hoc.',
    'options.biometric.messages.remove_failed': 'Khong the xoa mo khoa sinh trac hoc.',
    'content.overlay.button.biometric': 'Dung van tay / khuon mat',
    'content.overlay.button.biometric_waiting': 'Dang cho xac minh sinh trac hoc...',
    'content.overlay.error.biometric_failed': 'Xac minh sinh trac hoc that bai.',
    'background.error.biometric_not_setup': 'Chua cau hinh mo khoa sinh trac hoc.',
    'background.error.biometric_request_missing': 'Yeu cau sinh trac hoc da het han hoac khong ton tai.',
    'background.error.biometric_verification_failed': 'Xac minh sinh trac hoc that bai.',
    'background.error.biometric_cancelled': 'Da huy xac minh sinh trac hoc.',
    'background.error.biometric_tab_missing': 'Khong tim thay tab yeu cau mo khoa sinh trac hoc.',
    'background.error.biometric_public_key_missing': 'Chrome khong tra ve du lieu khoa cong khai hop le cho sinh trac hoc.',
    'biometric.window.document_title': 'Chrome Lock Pro X Sinh Trac Hoc',
    'biometric.window.title.setup': 'Dang ky mo khoa sinh trac hoc',
    'biometric.window.title.unlock': 'Mo khoa bang sinh trac hoc',
    'biometric.window.subtitle.setup': 'Chrome se yeu cau thiet bi xac minh van tay, khuon mat hoac PIN he thong va gan no voi extension nay.',
    'biometric.window.subtitle.unlock': 'Xac nhan bang van tay, khuon mat hoac PIN he thong de mo khoa phien duyet dang duoc bao ve.',
    'biometric.window.note': 'Extension khong doc du lieu van tay hoac khuon mat goc. Chrome chi tra ve ket qua WebAuthn da duoc xac minh.',
    'biometric.window.button.setup': 'Dang ky ngay',
    'biometric.window.button.unlock': 'Xac minh va mo khoa',
    'biometric.window.button.cancel': 'Huy',
    'biometric.window.status.ready_setup': 'San sang dang ky mo khoa sinh trac hoc cho extension nay.',
    'biometric.window.status.ready_unlock': 'San sang xac minh sinh trac hoc de mo khoa.',
    'biometric.window.status.running_setup': 'Dang cho thiet bi xac nhan thiet lap sinh trac hoc...',
    'biometric.window.status.running_unlock': 'Dang cho thiet bi xac minh ban...',
    'biometric.window.status.success_setup': 'Da dang ky mo khoa sinh trac hoc.',
    'biometric.window.status.success_unlock': 'Xac minh sinh trac hoc thanh cong.',
    'biometric.window.error.cancelled': 'Da huy xac minh sinh trac hoc.',
    'biometric.window.error.invalid_state': 'Thong tin sinh trac hoc nay khong dung duoc trong trang thai hien tai.',
    'biometric.window.error.unsupported': 'Ban Chrome hien tai khong ho tro WebAuthn sinh trac hoc tai day.',
    'biometric.window.error.platform_unavailable': 'Thiet bi nay khong co trinh xac thuc he thong nhu Windows Hello.',
    'biometric.window.error.context_missing': 'Yeu cau sinh trac hoc da het han hoac khong ton tai.',
    'biometric.window.error.no_public_key': 'Chrome khong tra ve du lieu credential hop le cho mo khoa sinh trac hoc.',
    'biometric.window.error.not_configured': 'Chua cau hinh mo khoa sinh trac hoc.',
    'biometric.window.error.generic': 'Xac minh sinh trac hoc that bai.'
  });
